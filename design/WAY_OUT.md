...
| 13:30 | **Water works** | [puzzle] Valves + pump, with valve B's kick-back (PR "puzzles"). **New link**: when the blue tank fills, the old turbine by the intake starts turning, and lights come on along a power line that runs north to the bridge. | Power reaches the bridge's control hut. |

...
func setup(b: Node) -> void:
	...
	objectives = [
		...
		{"id": "bridge", "text": "The lift bridge is up. Lower it from the control hut by the road",
			"hint": "One works the RAISE / LOWER levers in the hut (hold E) and watches the safety mirror outside its window. The other goes into the machinery house across the road, where the gear and the counterweight are.",
			"done": func(): return flags.has("bridge_down")},
		{"id": "cross", "text": "Cross the river and drive on to the ghat road",
			"hint": "Over the bridge, Pump House Road runs on to the junction at the foot of the hills.",
			"done": func(): return _van_near("j3", 60.0)},
		{"id": "ghat", "text": "Up the ghat road to the pass. Fog on the hairpins",
